...
<img src="/img/Fig 20.png" alt="Atlas DSIL SDK软件架构" width="50%" title="Atlas DSIL SDK软件架构" />

---

## ⏱️ 核心机制一：硬件时间戳透传

<img src="/img/Fig 21.png" alt="Atlas DSIL SDK工作流程" width="50%" title="Atlas DSIL SDK工作流程" />
